        ...
        <div className="aboutcont">
          ...
          <div>
              ...
              <div className='paracont'>
                <p className='para1'> We are proud to deliver an education that goes beyond textbooks
                  and classrooms.</p>
                <p className='para1'> Our students gain the technical skills, real-world experience,
                  and problem-solving ability <br /> needed to embrace complexity
                  and lead innocation in a rapidly changing workforce.</p>
                <p className='para1'>Through close collaboration with industry, our network of alumni
