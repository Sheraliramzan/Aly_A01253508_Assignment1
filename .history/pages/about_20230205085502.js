      ...
      <main className={styles.main}>
        <div className="aboutcont">
          ...
          <div>
              ...
              <p className='para3'> Big Info is the largest program expo and information session at
              ...
              <p className=''>If you missed our fall event the next Big Info is scheduled to
                return on February 15, 2023.
              </p>
              <h2>Campus Tours</h2>
              <p>  Tours run weekdays September to May, on our Burnaby campus. See
